...
[VolumeComponentMenuForRenderPipeLine("Custom/Comic Bloom", typeof(UniversalRenderPipeLine))]
public class BloomEffectShader : VolumeComponent, IPostProcessComponent
{
    ...
    public ClampedFloatParameter scatter = new ClampedFloatParameter(0.7, 0, 1, true);
